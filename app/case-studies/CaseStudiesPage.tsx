...
const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    dek: "How a fictional county could transform dozens of disconnected disaster-recovery resources into one resident-centered navigator, then use the prototype to align partners, define implementation, and support future funding conversations.",
